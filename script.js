  ...
  (function (g, u) {
    ...
    return (function (g) {
      function u(t) {
        ...
        return (
          g[t].call(c.exports, c, c.exports, u), (c.loaded = !0), c.exports
        );
      }
      var o = {};
      return (u.m = g), (u.c = o), (u.p = "dist/"), u(0);
    })([
      function (g, u, o) {
        function t(r) {
        ...
        var c =
            ...
            function (r) {
              for (var x = 1; x < arguments.length; x++) {
                var A = arguments[x];
                for (var H in A)
                  Object.prototype.hasOwnProperty.call(A, H) && (r[H] = A[H]);
              }
              return r;
            },
          b = o(1),
          ...
          z = function () {
            ...
            if ((r && (K = !0), K))
              return (_ = (0, J.default)(_, v)), (0, Y.default)(_, v.once), _;
          },
          D = function () {
            (_ = (0, B.default)()), z();
          },
          n = function () {
            _.forEach(function (r, x) {
          ...
          e = function (r) {
            return (
              r === !0 ||
              (r === "mobile" && O.default.mobile()) ||
              (r === "phone" && O.default.phone()) ||
              (r === "tablet" && O.default.tablet()) ||
              (typeof r == "function" && r() === !0)
            );
          },
          d = function (r) {
            (v = c(v, r)), (_ = (0, B.default)());
            var x = document.all && !window.atob;
            return e(v.disable) || x
              ? n()
    ...
    `),
                ...
                window.addEventListener(
                  ...
                  (0, i.default)(function () {
                    (0, Y.default)(_, v.once);
                  }, v.throttleDelay)
                ),
                v.disableMutationObserver || s.default.ready("[data-aos]", D),
                _);
          };
        g.exports = {
          init: d,
        ...
        (function (o) {
          function t(e, d, r) {
            function x(l) {
              var j = E,
                C = L;
              return (E = L = void 0), ($ = l), (k = e.apply(C, j));
            }
            function A(l) {
              return ($ = l), (h = setTimeout(I, d)), W ? x(l) : k;
            }
            function H(l) {
              var j = l - S,
                C = l - $,
            ...
            function F(l) {
              var j = l - S,
                C = l - $;
              return S === void 0 || j >= d || j < 0 || (P && C >= T);
            }
            function I() {
              var l = n();
              return F(l) ? V(l) : void (h = setTimeout(I, H(l)));
            }
            function V(l) {
              return (h = void 0), y && E ? x(l) : ((E = L = void 0), k);
            }
            function X() {
            ...
            function R() {
              return h === void 0 ? k : V(n());
            }
            function N() {
              var l = n(),
                j = F(l);
              if (((E = arguments), (L = this), (S = l), j)) {
                if (h === void 0) return A(S);
                if (P) return (h = setTimeout(I, d)), x(S);
              }
              return h === void 0 && (h = setTimeout(I, d)), k;
            }
            var E,
              L,
              T,
          ...
          function b(e) {
            var d = typeof e > "u" ? "undefined" : a(e);
            return !!e && (d == "object" || d == "function");
          }
          function w(e) {
            return !!e && (typeof e > "u" ? "undefined" : a(e)) == "object";
          }
          function i(e) {
            return (
              (typeof e > "u" ? "undefined" : a(e)) == "symbol" ||
              (w(e) && v.call(e) == m)
            );
          }
          function p(e) {
          ...
          var a =
            ...
            J = parseInt,
            Q =
              (typeof o > "u" ? "undefined" : a(o)) == "object" &&
              o &&
              o.Object === Object &&
              o,
            B =
        ...
        (function (o) {
          function t(n, e, d) {
            function r(y) {
              var l = N,
                j = E;
              return (N = E = void 0), (S = y), (T = n.apply(j, l));
            }
            function x(y) {
              return (S = y), (k = setTimeout(F, e)), $ ? r(y) : T;
            }
            function A(y) {
              var l = y - h,
                j = y - S,
            ...
            function H(y) {
              var l = y - h,
                j = y - S;
              return h === void 0 || l >= e || l < 0 || (W && j >= L);
            }
            function F() {
              var y = D();
              return H(y) ? I(y) : void (k = setTimeout(F, A(y)));
            }
            function I(y) {
              return (k = void 0), P && N ? r(y) : ((N = E = void 0), T);
            }
            function V() {
            ...
            function X() {
              return k === void 0 ? T : I(D());
            }
            function R() {
              var y = D(),
                l = H(y);
              if (((N = arguments), (E = this), (h = y), l)) {
                if (k === void 0) return x(h);
                if (W) return (k = setTimeout(F, e)), r(h);
              }
              return k === void 0 && (k = setTimeout(F, e)), T;
            }
            var N,
              E,
              L,
            ...
            return (
              ...
              c(d) &&
                (($ = !!d.leading),
                (W = "maxWait" in d),
                (L = W ? v(i(d.maxWait) || 0, e) : L),
                (P = "trailing" in d ? !!d.trailing : P)),
              (R.cancel = V),
              (R.flush = X),
              R
            );
          ...
          function c(n) {
            var e = typeof n > "u" ? "undefined" : p(n);
      ...
      function (g, u) {
        ...
        var c = (function () {
            ...
            return function (s, m, O) {
              return m && f(s.prototype, m), O && f(s, O), s;
            };
          })(),
          b =
            ...
            return (
              c(f, [
                ...
                },
                {
                  ...
                  value: function () {
                    var s = t();
                    return !(!i.test(s) && !p.test(s.substr(0, 4)));
                  },
                },
                {
                  key: "tablet",
      ...
      function (g, u) {
        ...
        var o = function (t) {
          for (
            ...
            (c += t.offsetLeft - (t.tagName != "BODY" ? t.scrollLeft : 0)),
              (b += t.offsetTop - (t.tagName != "BODY" ? t.scrollTop : 0)),
              (t = t.offsetParent);
          return {
            top: b,
            left: c,
      ...
      function (g, u) {
        ...
        var o = function (t) {
          return (
            ...
            Array.prototype.map.call(t, function (c) {
              return {
                node: c,
              };
            })
